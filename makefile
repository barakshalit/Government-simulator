...
bin/cRace: bin/main.o bin/Agent.o bin/Graph.o bin/Parser.o bin/Party.o bin/Simulation.o bin/EdgeWeightSelectionPolicy.o bin/MandatesSelctionPolicy.o bin/LastOfferJoinPolicy.o bin/MandatesJoinPolicy.o
	g++ -o bin/cRace bin/main.o bin/Agent.o bin/Graph.o bin/Parser.o bin/Party.o bin/Simulation.o bin/EdgeWeightSelectionPolicy.o bin/MandatesSelctionPolicy.o bin/LastOfferJoinPolicy.o bin/MandatesJoinPolicy.o
...
bin/MandatesSelctionPolicy.o: src/MandatesSelctionPolicy.cpp
	g++ -g -Wall -Weffc++ -std=c++11 -c -Iinclude -o bin/MandatesSelctionPolicy.o src/MandatesSelctionPolicy.cpp
